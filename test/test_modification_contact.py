...
def test_modification_contact(app):
    ...
    app.contact.modification__first_contact(Contact(firstname="upd1", middlename="upd1", lastname="upd1", nickname="upd1", title="upd1", company="upd1", address="upd1", phone_home="1",
