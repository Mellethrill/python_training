...
class ContactHelper:
    ...
    def get_contact_list(self):
        if self.contact_cache is None:
            ...
            for element in wd.find_elements_by_css_selector("tr[name]"):
                ...
                self.contact_cache.append(Contact(id=id, lastname=last_name, firstname=first_name, all_phones_from_home_page=all_phones, all_emails_from_home_page=all_emails, address=address))
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(firstname=firstname, lastname=lastname, id=id, phone_home=phone_home, phone_work=phone_work, phone_mobile=phone_mobile, phone2=phone2, email1=email1, email2=email2, email3=email3, address=address)
